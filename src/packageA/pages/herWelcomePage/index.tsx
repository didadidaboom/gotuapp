...
interface HerWelcomePage {
  props: PageStateProps;
}

@inject("store")
@observer
class HerWelcomePage extends Component {
  state = {
    showToast: false,
    toast: {
      msg: "请选择年龄",
  ...
  render() {
    return (
      <View className="w-full h-full flex-col justify-center items-center inline-flex">
        ...
        >
          <View className="Welcomepart w-full h-full px-4 pt-2 flex-col justify-between items-center inline-flex">
            ...
            <View className="Bottom w-full self-stretch h-10 flex-col justify-center items-center gap-4 flex">
              <View className="Button drop-shadow-2xl self-stretch py-1.5 bg-orange-500 rounded-3xl shadow justify-center items-center inline-flex"
