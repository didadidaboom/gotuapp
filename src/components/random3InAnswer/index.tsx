...
interface Random3InAnswerItemProps {
  onClick: Function;
  orderItem: any;
  credit: any;
  selectedItem: any;
...
@observer
export default class Random3InAnswerItem extends Component<Random3InAnswerItemProps> {
  onSubmmitPayment = () => {
    // console.log("inside")
            ...
            <View className="Credititem w-full py-2 justify-center items-center gap-3 flex flex-row flex-wrap">
              {orderItem.map((item, index) => {
                return selectedItem.id === item.id ? (
                  <View className="Charge drop-shadow-2xl w-26 h-20 px-0.5 py-2 bg-orange-100 rounded-lg border border-orange-500 flex-col justify-center items-center gap-2 inline-flex">
                    {item.discount != 10 && (
                      <View
                    ...
                    <View className="Button drop-shadow-xl self-stretch px-4 py-1.5 bg-orange-500 rounded-3xl shadow justify-center items-center inline-flex">
                  ...
                  >
                    ...
                    <View className="Button drop-shadow-xl self-stretch px-4 py-1.5 bg-gray-400 rounded-3xl shadow justify-center items-center inline-flex">
                      <View className="Content text-center text-white text-lg font-bold font-['Inter'] leading-7">
                        {item.credit}
                      </View>
                      <IconFont name="icon-credit" size={36} />
