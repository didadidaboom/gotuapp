...
class AvatarPage extends Component {
  ...
  submitAvatar = () => {
    ...
    if (!isPass) {
      ...
      profileStore.profile.avatar = registerStore.avatar;
      this.gobackClick();
    }
  };
  ...
  render() {
    ...
    return (
      <View className="w-full h-full flex-col justify-center items-center inline-flex">
        ...
        >
          <View className="Avatarpart w-full h-full px-4 flex-col justify-between items-center inline-flex">
            <View className="Upper w-full self-stretch h-full flex-col justify-between items-center inline-flex">
              <View className="SkipButton self-stretch px-1.5 justify-end items-center gap-2.5 inline-flex">
                <View
                  className="Skip text-center text-orange-300 text-xs font-semibold font-['Inter'] leading-none"
